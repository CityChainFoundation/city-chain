...
namespace NBitcoin.Networks
{
    ...
    {
        /// <summary> The name of the root folder containing the different City blockchains (CityMain, CityTest). </summary>
        ...
        public CityMain()
        {
            ...
            this.Consensus.BIP34Hash = 0; // https://bitcoin.stackexchange.com/a/54517
            ...
            this.Consensus.CoinType = 4200;
            this.Consensus.DefaultAssumeValid = new uint256("0x55a8205ae4bbf18f4d238c43f43005bd66e0b1f679b39e2c5c62cf6903693a5e"); // 795970
            this.Consensus.CoinbaseMaturity = 200; // Increased to increase network security
            this.Consensus.PremineReward = Money.Coins(21000000); // 21 million coins //Money.Coins(98000000); 
            ...
            // No need to modify these, same as Bitcoin and Stratis.
            ...
            string[] seedNodes = { "10.0.0.122", "10.0.0.192" };
            this.SeedNodes = ConvertToNetworkAddresses(seedNodes, this.DefaultPort).ToList();

            // Create the genesis block.
            this.GenesisTime = 1529418200; // 06/19/2018 @ 2:23pm (UTC)
            this.GenesisNonce = 1202132;
            this.GenesisBits = 0x1e0fffff;
            this.GenesisVersion = 1;
            this.GenesisReward = Money.Zero;

            this.Genesis = CreateCityGenesisBlock(this.Consensus.ConsensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward);
            this.Consensus.HashGenesisBlock = this.Genesis.GetHash();

            Assert(this.Consensus.HashGenesisBlock == uint256.Parse("0x0000006ac7d36905503c522aafed12f05ad4076f79c9d50c0c2f2dffdb4b370b"));
            Assert(this.Genesis.Header.HashMerkleRoot == uint256.Parse("0x779694efd4fe6679df3007a9d3a0e0ea95d5bc8816d1a3b67d6124eec67ee62f"));
        }

        protected static Block CreateCityGenesisBlock(ConsensusFactory consensusFactory, uint nTime, uint nNonce, uint nBits, int nVersion, Money genesisReward)
        {
            string pszTimestamp = "https://morgenbladet.no/aktuelt/2017/08/privatlivets-fred-i-liberstad";
